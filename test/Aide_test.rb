...
class TestAide < Test::Unit::TestCase
	...
	# def test_listeCasesGazon
	# 	grille=Grille.new(6, true, 1097)
	# 	aide = Aide.new(grille)
	# 	newStatutVide = StatutVide.new(:VIDE)
	
	# 	assert(aide.listeCasesGazon != @@sansSucces, "Il n'y a plus de cases ou il reste du gazon a placer sans qu'il ne touche d'arbre")
	...
	# 	assert(aide.listeCasesGazon == @@sansSucces, "Il y a une/plusieurs case(s) ou il reste du gazon a placer sans qu'il ne touche d'arbre")
	# end
