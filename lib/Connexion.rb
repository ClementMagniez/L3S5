...
class Connexion
	...
	# 	@enregistrerScore booléen permettant de savoir si le joueur souhaite enre ses scores

	attr_reader :id, :login, :difficulte, :mode, :score, :sauvegardeScores
	attr_writer :login, :difficulte, :mode, :score, :sauvegardeScores
